...
public class Recipes {
    public static void init() {
        ...
        GameRegistry.addRecipe(new ItemStack(ModItems.cardboardTube, 4), " c ", "c c", " c ", 'c', new ItemStack(ModItems.cardboard));
        //Blocks
        GameRegistry.addRecipe(new ItemStack(ModBlocks.cardboardCube, 2), "cc", "cc", 'c', new ItemStack(ModItems.cardboard));
        GameRegistry.addRecipe(new ItemStack(ModBlocks.cardboardFrame, 1), " t ", "t t", " t ", 't', new ItemStack(ModItems.cardboardTube));
    }
}
